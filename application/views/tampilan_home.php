  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 ml-auto">
        <div class="block-15">
          <div class="heading">
            <h2>Pendidikan adalah Kehidupan</h2>
          </div>
          <div class="text mb-5">
            <h6>Melalui pendidikan, siswa bisa menggali potensi mereka secara lebih sehingga bakat yang dimiliki juga akan semakin terasah.</h6>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-5 element-animate">
      <div class="col-md-7 text-center section-heading">
        <h2 class="text-white heading">Popular News</h2>
      </div>
    </div>
  </div>
...
<div class="container site-section element-animate">
  ...
  <div class="row">
    <div class="col-md-6 col-lg-4">
      <div class="block-2">
        <div class="flipper">
          <div class="front" style="background-image: url(assets/images/Yono.jpg);">
            <div class="box">
              <h2>SWIYONO</h2>
              <p>Wakil Kepala Sekolah <Span>Bidang Kesiswaan</Span></p>
            </div>
          </div>
          <div class="back">
            <!-- back content -->
            ...
            <div class="author d-flex">
              <div class="image mr-3 align-self-center">
                <img src="<?= base_url() ?>assets/images/Yono.jpg" alt="">
              </div>
              <div class="name align-self-center">SWIYONO <span class="position">Wakil Kepala Sekolah <Span>Bidang Kesiswaan</span></div>
            </div>
          </div>
        </div>
      </div> <!-- .flip-container -->
    ...
    <div class="col-md-6 col-lg-4">
      <div class="block-2 ">
        <div class="flipper">
          <div class="front" style="background-image: url(assets/images/winar.jpg);">
            <div class="box">
              <h2>WINARTO, SH</h2>
              <p>Kepala Sekolah</p>
            </div>
          ...
          <div class="back">
            ...
            <div class="author d-flex">
              <div class="image mr-3 align-self-center">
                <img src="<?= base_url() ?>assets/images/winar.jpg" alt="">
              </div>
              <div class="name align-self-center">WINARTO, SH <span class="position">Kepala Sekolah</span></div>
            </div>
          </div>
        </div>
      </div> <!-- .flip-container -->
    ...
    <div class="col-md-6 col-lg-4">
      <div class="block-2">
        <div class="flipper">
          <div class="front" style="background-image: url(assets/images/widodo.jpg);">
            <div class="box">
              <h2>WIDODO</h2>
              <p>Wakil Kepala Sekolah <span>Bidang Humas</span></p>
            </div>
          </div>
          <div class="back">
            <!-- back content -->
            ...
            <div class="author d-flex">
              <div class="image mr-3 align-self-center">
                <img src="<?= base_url() ?>assets/images/widodo.jpg" alt="">
              </div>
              <div class="name align-self-center">WIDODO <span class="position">Wakil Kepala Sekolah Bidang Humas</span></div>
            </div>
          </div>
        </div>
      </div> <!-- .flip-container -->
