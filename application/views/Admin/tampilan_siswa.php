<div class="alert alert-success" role="alert">
    <h5 class="text-center text-uppercase font-weight-bold">sisiwa</h5>
</div>
<div class="row">
    <div class="col-md">
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-success btn-sm text-uppercase font-weight-bold" data-toggle="modal" data-target="#exampleModal">
                    <i class="fas fa-plus-square"></i> Upload sisiwa
                </button>
                <a class="btn btn-danger btn-sm text-uppercase font-weight-bold" href="<?= base_url() ?>Dashboard/hapus_all_siswa"><i class="fas fa-trash"></i> Hapus sisiwa</a>
            </div>
        </div>
    </div>
</div>
                ...
                <tbody>
                    <tr>
                        ...
                        ?>
                            ...
                            <td>
                                <h5 class="text-center"><a class="btn btn-danger btn-sm" href="<?= base_url() ?>Dashboard/detail_siswa/<?= $row['id_tahun_ajaran']; ?>">Detail</a></h5>
                            </td>
                    </tr>
                <?php } ?>
                </tbody>
